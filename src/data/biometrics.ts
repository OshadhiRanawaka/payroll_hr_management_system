...
export const syncLogs: SyncLog[] = [
  {
    id: 'sync-log-101',
    deviceId: 'dev-hor-01',
    syncTimestamp: '2026-09-12T09:42:00Z',
    eventsSynced: 142,
    status: 'success',
  },
  {
    id: 'sync-log-102',
    deviceId: 'dev-col-01',
    syncTimestamp: '2026-09-12T09:41:20Z',
    eventsSynced: 68,
    status: 'success',
  },
  {
    id: 'sync-log-103',
    deviceId: 'dev-hor-02',
    syncTimestamp: '2026-09-12T08:15:44Z',
    eventsSynced: 22,
    status: 'partial',
    errorMessage: 'Network timeout during bulk packet transmission — 48 records queued.',
  },
  {
    id: 'sync-log-104',
    deviceId: 'dev-kdy-02',
    syncTimestamp: '2026-09-11T18:30:00Z',
    eventsSynced: 0,
    status: 'failed',
    errorMessage: 'Device unreachable at IP 192.168.30.51 — Gateway unreachable.',
  },
]
